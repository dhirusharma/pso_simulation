...
class Node(object):
    def __init__(self, id, parent=None):
        ...
        self.head_assigned = False # For Checking a sensor has been assigned to a cluster
        self.is_gateway = False # For keeping track og Gateway
    ...
    def update_sleep_prob2(self, nb_neighbors):
        ...
        if self.distance_to_endpoint == 0:
            ...
            term2 = PSO_F*(self.distance_to_endpoint-1) / \
                self.distance_to_endpoint
